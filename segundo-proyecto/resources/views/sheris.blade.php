    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        ...
        <div class="carousel-item" style="height: 100vh;">
          <img src="{{ asset('img/huevos.jpg') }}" class="d-block" alt="Decoraciones y Huevos Sheris" style="width: 100%; height: 100%; object-fit: cover;">
        </div>

        <div class="carousel-item" style="height: 100vh;">
          <img src="{{ asset('img/madres.jpg') }}" class="d-block" alt="Especial Día de las Madres Sheris" style="width: 100%; height: 100%; object-fit: cover;">
        </div>
  ...
  <div class="row g-4">
      ...
      <div class="card h-100 shadow">
        <button type="button" class="btn p-0 text-start">
          <div class="d-flex align-items-center justify-content-center" style="height: 250px; overflow: hidden;">
            <img src="{{ asset('img/uno.jpg') }}" class="w-100 h-auto" alt="Juego de cartas UNO">
          </div>
          <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card h-100 shadow">
        <button type="button" class="btn p-0 text-start">
          <div class="d-flex align-items-center justify-content-center" style="height: 250px; overflow: hidden;">
            <img src="{{ asset('img/figura_spiderman.jpg') }}" class="w-100 h-auto" alt="Figura de Spiderman">
          </div>
          <div class="card-body">
            <h5 class="card-title fw-bold text-morena">El Hombre Que Araña</h5>
    ...
    <div class="row justify-content-center g-4">
      ...
      <div class="col-md-4">
        <div class="card h-100 text-center">
          <img src="{{ asset('img/dia_del_niño.jpg') }}" class="card-img-top img-fluid" alt="Promoción Día del Niño" style="height: 250px; object-fit: cover;">
      ...
      <div class="col-md-4">
        <div class="card h-100 text-center">
          <img src="{{ asset('img/dia_de_la_madre.jpg') }}" class="card-img-top img-fluid" alt="Promoción Día de la Madre" style="height: 250px; object-fit: cover;">
          <div class="card-body d-flex flex-column">
      ...
      <div class="col-md-4">
        <div class="card h-100 text-center">
          <img src="{{ asset('img/dia_del_padre.jpg') }}" class="card-img-top img-fluid" alt="Promoción Día del Padre" style="height: 250px; object-fit: cover;">
          <div class="card-body d-flex flex-column">
...
<section id="sobre-nosotros" class="container my-5">
  <div class="row align-items-center">
    ...
    <div class="col-md-4 text-start">
      <img src="{{ asset('img/sheris.jpg') }}" alt="Logo de Sheris" class="img-fluid rounded">
    </div>
    ...
    <div class="col-md-8 text-start">
      ...
      <figure>
        ...
        <figcaption class="blockquote-footer">
          Rosa Melano <cite title="Source Title">Del Equipo de Sheris</cite>
        </figcaption>
      </figure>
    </div>
  </div>
